...
const Contact = (props: Props) => {
  return (
    <BaseLayout>
      ...
      <Link href="mailto:enockscoleman@gmail.com" target={"_blank"} className={"flex cursor-pointer items-center gap-x-2 py-1 text-xl font-bold text-white hover:text-pink-400"}>
        <MailIcon />
